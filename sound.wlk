...
object gestorMusica {
    ...
    //Consultas
    method estaPausado() { return musicaActual.paused() }
...
const gameOverMusic  = new Audio( nombre = "musica-fin.mp3" )
...
const pokeballSound  = new Audio( nombre = "pokeball-sound.mp3"  )